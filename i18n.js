...
(() => {
  ...
  const DICT = {
    es: {
      ...
      pagination_showing: (start, end, total) => `Mostrando ${start}–${end} de ${total} fondos`,
      featured_title: "Exclusivos más populares",
      hero_explore: "Explorar fondos",
      hero_saved: "Guardar favoritos",
      nav_home: "Inicio",
    ...
    en: {
      ...
      pagination_showing: (start, end, total) => `Showing ${start}–${end} of ${total} wallpapers`,
      featured_title: "Most popular exclusives",
      hero_explore: "Explore wallpapers",
      hero_saved: "Saved favorites",
      nav_home: "Home",
      nav_popular: "Popular",
    ...
    pt: {
      ...
      pagination_showing: (start, end, total) => `Mostrando ${start}–${end} de ${total} papéis de parede`,
      featured_title: "Exclusivos mais populares",
      hero_explore: "Explorar fundos",
      hero_saved: "Favoritos salvos",
      nav_home: "Início",
      nav_popular: "Populares",
    ...
    fr: {
      ...
      pagination_showing: (start, end, total) => `Affichage de ${start}–${end} sur ${total} fonds`,
      featured_title: "Exclusivités les plus populaires",
      hero_explore: "Explorer les fonds",
      hero_saved: "Favoris enregistrés",
      nav_home: "Accueil",
    ...
    de: {
      ...
      pagination_showing: (start, end, total) => `Zeige ${start}–${end} von ${total} Wallpaper`,
      featured_title: "Beliebteste Exklusiv-Wallpaper",
      hero_explore: "Wallpaper erkunden",
      hero_saved: "Gespeicherte Favoriten",
      nav_home: "Start",
      nav_popular: "Beliebt",
